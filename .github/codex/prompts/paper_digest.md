...
- `2026.5.2` 我觉得你这几期blog有几个问题出现，以后可以改善一下，比如每篇paper都没引入，其实不一定读者知道这个领域，还有就是一些表你重制的很丑，你要不直接在blog中写markdown展示表，优先还是截图，然后我觉得对于一些理论的文章也可以适当展示公式，我期望这个栏目还是要有深度，深入浅出，让人掌握大方向也能get一些准确的细节。
