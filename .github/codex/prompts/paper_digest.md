...
- `2026.5.7` 每次blog产出后要检查形式，比如图片是否截取正确，是否放在了正确的位置。
- `2026.5.2` 我觉得你这几期blog有几个问题出现，以后可以改善一下，比如每篇paper都没引入，其实不一定读者知道这个领域，还有就是一些表你重制的很丑，,对于你所有想掌握的表请你识别后自己markdown代码写在blog中不要截图，然后我觉得对于一些理论的文章也可以适当展示公式，我期望这个栏目还是要有深度，深入浅出，让人掌握大方向也能get一些准确的细节。
