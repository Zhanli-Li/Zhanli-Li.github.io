...
\faGithub\ \href{https://github.com/Zhanli-Li}{Zhanli-Li (180+ stars)}
}
...
{\bf \href{https://www.kaggle.com/competitions/nvidia-nemotron-model-reasoning-challenge/leaderboard}{NVIDIA Nemotron Model Reasoning Challenge} \quad \textit{Silver Medal}} \hfill {\em June 2026} \\
On a new \textbf{abstract puzzle reasoning benchmark} built around NVIDIA Nemotron open reasoning models, we used \textbf{Nemotron-3-Nano-30B-A3B} as the backbone and explored ways to improve reasoning accuracy under the competition-required \textbf{LoRA fine-tuning} setting. The benchmark emphasized multi-step deduction under strict prefix constraints, so we built an \textbf{agentic reasoning} framework that repeatedly generated candidate solutions, checked them against the puzzle rules, and fed failed attempts back into the next search round. We further optimized the \textbf{rule orchestration} process by clustering and ordering discovered rules into a \textbf{low-entropy} representation: redundant heuristics were merged or pruned, rule triggers were made explicit, and solver priorities were arranged to expose stable, learnable decision paths. This turned ad hoc discoveries into a compact rule system of reusable \textbf{solvers}, making the rules easier for the model to learn, retrieve, and reuse while preserving prefix-reasoning consistency and answer verifiability across related puzzles, ultimately achieving a score of \textbf{0.86}. \\
$\triangleright$~ \href{https://www.kaggle.com/competitions/nvidia-nemotron-model-reasoning-challenge/leaderboard}{\textbf{Kaggle Leaderboard Silver Medal}}, ranked \textbf{119/4182} globally on the final leaderboard.
...
{\bf NVIDIA Nemotron Model Reasoning Challenge} \hfill {\em June 2026} \\
Silver Medal; ranked 119/4182 globally on the final Kaggle leaderboard.
