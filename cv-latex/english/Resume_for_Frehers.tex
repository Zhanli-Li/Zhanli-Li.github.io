...
On a new \textbf{abstract puzzle reasoning benchmark} built around NVIDIA Nemotron open reasoning models, we used \textbf{Nemotron-3-Nano-30B-A3B} as the backbone and explored ways to improve reasoning accuracy under the competition-required \textbf{LoRA fine-tuning} setting. We built an \textbf{agentic reasoning} framework to iteratively solve unsolved puzzles, then organized the induced rules into reusable \textbf{solvers} to preserve prefix-reasoning consistency and answer verifiability, achieving a score of \textbf{0.86}. \\
