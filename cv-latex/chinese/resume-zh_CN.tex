...
针对基座模型数据分析中\textbf{下钻不足、洞察停留表层}的问题，围绕 \textbf{LongCat 2.0 Pro} 设计 \textbf{Data Agent} 后训练方案；构建\textbf{合成交互式分析环境生成 pipeline}、\textbf{轨迹筛选 pipeline}，并探索与其他 post-training 数据的\textbf{混合配比策略}，支撑其在 \textbf{BA Agent / Data Agent} 任务中的\textbf{下钻能力}与 \textbf{insight 质量}提升。\\
$\triangleright$~ 搭建了 Env 合成流程、深度分析轨迹筛选流程，以及 Data Agent 数据在后训练中的配比策略
...
\textbf{导师:} 洪峰 \quad \textbf{项目:} BA Agent 能力提升；参与 \textbf{LongCat 2.0 Pro} 在真实业务数据分析场景中的后训练与能力增强。
