...
🎓 From 2024 to February 2025, I had the privilege of being mentored by [Prof. Zichao Yang (杨子超)](https://www.yzc.me) at ZUEL, where I conducted research on causal inference. From February 2025 to March 2026, I was an intern supervised by [Prof. Yixuan Cao (曹逸轩)](https://yixuancao.github.io/) at the [State Key lab of AI Safety, Institute of Computing Technology](https://klais.ict.ac.cn/) and <a href="https://www.paodingai.com/" style="display:inline-flex;align-items:center;gap:0.25rem;vertical-align:middle;"><img src="{{ '/images/logos/pai-tech.png' | relative_url }}" alt="PAI TECH logo" style="height:1.35em;width:auto;">PAI TECH (庖丁科技)</a>, working on document intelligence in collaboration with [Prof. Ping Luo (罗平)](https://ping-luo.github.io/)'s team using their advanced PDF parsing model, [PDFlux](https://pdflux.com/en/). I am currently interning at <span style="display:inline-flex;align-items:center;gap:0.25rem;vertical-align:middle;"><img src="{{ '/images/logos/longcat-interaction.png' | relative_url }}" alt="LongCat Interaction logo" style="height:1.35em;width:auto;">LongCat Interaction</span>, where my research focuses on Agentic Training.
...
## News 📧
- `2026.6.17` I'm about to start my internship at <span style="display:inline-flex;align-items:center;gap:0.25rem;vertical-align:middle;"><img src="{{ '/images/logos/longcat-interaction.png' | relative_url }}" alt="LongCat Interaction logo" style="height:1.35em;width:auto;"><strong>LongCat Interaction</strong></span> (Shanghai)!
