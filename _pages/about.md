...
🎓 From 2024 to February 2025, I had the privilege of being mentored by [Prof. Zichao Yang (杨子超)](https://www.yzc.me) at ZUEL, where I conducted research on causal inference. From February 2025 to March 2026, I was an intern supervised by [Prof. Yixuan Cao (曹逸轩)](https://yixuancao.github.io/) at the [State Key lab of AI Safety,Institute of Computing Technology](https://klais.ict.ac.cn/) and [PAI TECH (庖丁科技)](https://www.paodingai.com/), working on document intelligence in collaboration with [Prof. Ping Luo (罗平)](https://ping-luo.github.io/)'s team using their advanced PDF parsing model, [PDFlux](https://pdflux.com/en/) [Try PDF Parser]({{ '/pdf-parser/' | relative_url }}){: .btn .btn--primary .btn--small }. More Recently, I am also honored to have been selected as a visiting student in the Shenlan Program (深澜计划) at [Zhongguancun Academy (中关村学院)](https://bza.edu.cn/), where I will work with [Prof. Wentao Zhang (张文涛)](https://zwt233.github.io/) and a group of outstanding senior students in the coming months.
